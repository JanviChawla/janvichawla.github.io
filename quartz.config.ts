  ...
  configuration: {
    ...
    theme: {
      ...
      typography: {
        ...
        body: "EB Garamond", // Crimson Pro, Ibarra Real Nova
        code: "Red Hat Mono",
      },
      colors: {
        lightMode: {
          ...
          dark: "#2b2b2b", // 2b2b2b
          secondary: "rgba(79, 13, 24, 1)", //284b63
          tertiary: "rgba(212, 143, 172, 1)", //84a59d
          highlight: "rgba(245, 189, 211, 0.15)", // rgba(143, 159, 169, 0.15) 
        },
        darkMode: {
          light: "#161619", // 161618
